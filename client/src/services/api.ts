...
const getApiBaseUrl = () => {
  ...
  // Production: route to the deployed backend
  if ((import.meta as any).env?.PROD) {
    return 'https://nourish-neural-backend.vercel.app'
  }

  // Dev: empty string lets Vite proxy handle /api requests to localhost:5000
  return ''
}
