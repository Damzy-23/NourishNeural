...
adda  a graphical feature that helps the household/user to see the amount of food that has been wasted over a period of time and the amount of money that has been saved by using the app.